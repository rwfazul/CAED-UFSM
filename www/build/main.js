...
var LoginProvider = /** @class */ (function () {
    ...
    LoginProvider.prototype.sendPostResquest = function (data) {
        ...
        return new Promise(function (resolve, reject) {
            _this.http.post('/authenticate', JSON.stringify(data), httpOptions)
...
var MyApp = /** @class */ (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"/home/isabella/Documentos/UFSM-2018-2/CAED-UFSM/src/app/app.html"*/'<ion-split-pane>\n  \n<ion-menu [content]="content">\n  <ion-header>\n    <ion-toolbar>\n      <ion-title>CAED UFSM</ion-title>\n    </ion-toolbar>\n  </ion-header>\n\n  <ion-content>\n    <ion-list>\n      <button menuClose ion-item icon-start *ngFor="let p of pages" (click)="openPage(p)">\n          <ion-icon name={{p.icon}}></ion-icon>\n        {{p.title}}\n      </button>\n    </ion-list>\n  </ion-content>\n</ion-menu>\n\n<!-- Disable swipe-to-go-back because it\'s poor UX to combine STGB with side menus -->\n<ion-nav [root]="rootPage" #content swipeBackEnabled="false" main></ion-nav>\n</ion-split-pane>'/*ion-inline-end:"/home/isabella/Documentos/UFSM-2018-2/CAED-UFSM/src/app/app.html"*/
        }),
